...
import { Calendar, Clock, Stethoscope, User, Loader2, CheckCircle, Video, Edit, X } from "lucide-react";
...
function AppointmentCard({ appointment, userRole }) {
    ...
    async function handleCancelAppointment() {
        ...
        if (window.confirm("Are you sure you want to cancel the appointment? This action cannot be undone!")) {
            const formData = new FormData();
            formData.append("appointmentId", appointment.id);
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <div className="flex items-center mt01 text-sm text-muted-foreground">
                            ...
                            <Badge variant="outline"
                                className={
                                    appointment.status === "COMPLETED"
                                        ? "bg-emerald-900/20 border-red-900/30 text-emerald-400"
